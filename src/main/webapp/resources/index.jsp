...
<head>
    ...
    <script type="text/javascript" src="../scripts/player/splitter.js"></script>
    <script type="text/javascript" src="../scripts/axutils.js"></script>
    <script type="text/javascript" src="../scripts/player/axplayer.js"></script>
        ...
        $(document).ready(function() {
            ...
            if($axure.player.settings.loadFeedbackPlugin) {
                if($axure.player.settings.isAxshare) {
                    $axure.utils.loadJS('plugins/feedback/feedback.js');
                } else {
...
<div id="maximizePanelContainer">
    <iframe id="expandFrame" src="../expand.jsp" width="100%" height="100%" scrolling="no" allowtransparency="true" frameborder="0"></iframe>
</div>
